...
- Thorough testing : [exrex](https://github.com/asciimoo/exrex) is used to randomly generate valid test-data from regex patterns, which are compared for verification against the Python implementation. Try `make test` to generate a few thousand tests cases yourself.
